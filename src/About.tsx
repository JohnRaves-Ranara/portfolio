        ...
        <section id="about-section" className="flex flex-col items-center justify-center px-8 py-24 lg:flex-row bg-[#f9f9f9]">
            <div className="gap-8 flex flex-col lg:gap-12 lg:flex-row items-center justify-center max-w-[65rem]">
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-center lg:text-start font-hnd-thin text-[18px]'>I am actively enhancing my skills in programming. The tech-stack I am confident in are Flutter and HTML/CSS. I am currently working on my JS skills.</p>
                </div>
            </div>
        </section>
    )
